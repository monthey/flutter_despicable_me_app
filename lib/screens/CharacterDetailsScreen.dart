            ...
            children: <Widget>[
                ...
                child: InkWell(
                    child: IconButton(
                        ...
                        onPressed: () {
                          setState(() {
                            isCollapsed = true;
                            _bottomSheetPosition = widget._completeCollapsedBottomSheet;
                          });
              ...
              Padding(
                padding: const EdgeInsets.only(
                    left: 25, top: 0, right: 8, bottom: 30),
                ...
                children: <Widget>[
                  InkWell(
                    ...
                    child: Container(
                      ...
                      height: 80,
                      child: Text("Clips", style: AppTheme.subHeading.copyWith(color: Colors.black),),
                    ),
                  ),
                  SingleChildScrollView(
